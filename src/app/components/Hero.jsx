...
<div>
 ...
 {/* end */}
        ...
        <span className="divider" style={{marginTop:'-1.67em'}}>
  <span className="divider-line"></span>
...
{/*  */}
       ...
       <h1 style={{ fontSize: '1.86ch',textAlign:'left',paddingLeft:'2.5em',width:'88%',lineHeight:'1.4',filter:'contrast(1.5)',textShadow:'2px 3px solid rgba(0,0,0,0.32)' }}>At <strong>Mission 007 NFP</strong> <span style={{fontWeight:'normal'}}>our purpose is to empower and inspire youth ages 16-25 to unlock their full potential and pursue their dreams with confidence. We provide mentorship, resources, and a supportive community to help young individuals set meaningful goals, develop essential skills, and overcome challenges.	</span></h1>
       <div className="anchored-cta-quote">
         <a href="#contact" className="button" style={{left:'50%'}}>Contact Us Now</a>
